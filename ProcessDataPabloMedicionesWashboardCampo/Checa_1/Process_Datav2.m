...
file_names = {'Checa_1_test2_vel10.mat', 'Checa_1_test3_vel20.mat', 'Checa_1_test2_vel40.mat', 'Checa_1_test2_vel60.mat'};
...
for i = 1:length(file_names)
    ...
    xlim([1, 10]); % Ajusta según sea necesario
...
for i = 1:length(file_names)
    ...
    xlim([20, 30]); % Ajusta según sea necesario
    ylim([-30, 30]); % Ajusta para mejorar la visualización
...
function [acelerometro1_filtrado, acelerometro2_filtrado] = filter_accelerometer_data(acelerometro1_centrada, acelerometro2_centrada, Fs)
    f_corte_highpass = 1.0; % Frecuencia de corte del filtro de paso alto (Hz).
...
function [vel1, distancia1, vel2, distancia2, d_laser,d_laser_smooth] = integrate_accelerometer_data(time, acelerometro1_filtrado, acelerometro2_filtrado, laser, Resis, MR)
    ...
    f_corte_bajo = 1.5; % Frecuencia de corte baja (Hz).
