...
file_names = {'Malchi_2_test1_vel10.mat', 'Malchi_2_test1_vel20.mat', 'Malchi_2_test3_vel40.mat', 'Malchi_2_test1_vel60.mat'};
...
% set(gcf, 'Position', [100, 100, 800, 600]); % Establece nuevo ancho y alto manteniendo x, y
...
function [vel1, distancia1, vel2, distancia2, d_laser,d_laser_smooth] = integrate_accelerometer_data(time, acelerometro1_filtrado, acelerometro2_filtrado, laser, Resis, MR)
    ...
    f_corte_bajo = 0.5; % Frecuencia de corte baja (Hz).
