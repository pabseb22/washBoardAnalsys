...
file_names = {'Malchi_3_test5_vel10.mat', 'Malchi_3_test2_vel20.mat', 'Malchi_3_test5_vel40.mat', 'Malchi_3_test2_vel60.mat'};
...
for i = 1:length(file_names)
    ...
    xlim([0, 10]); % Ajusta según sea necesario
...
function [vel1, distancia1, vel2, distancia2, d_laser,d_laser_smooth] = integrate_accelerometer_data(time, acelerometro1_filtrado, acelerometro2_filtrado, laser, Resis, MR)
    ...
    f_corte_bajo = 2; % Frecuencia de corte baja (Hz).
