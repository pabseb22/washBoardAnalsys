...
TEST_CASES = [
    ...
    # {'velocity': '0.78ms', 'D': 1.2, 'Q': 0.2, 'L0': -70.89, 'b': 68.99, 'boundaries': [6, 25], 'min_distance': 200, 'low_pass':0.02,'control_steps':[5,15,35,75], 'save_images':True, 'compare_fft': True,'obtain_amplitude':True ,'obtain_scalogram': False},
    # {'velocity': '1.03ms', 'D': 1.2, 'Q': 0.2, 'L0': -50.67, 'b': 51.23, 'boundaries': [7, 37], 'min_distance': 200, 'low_pass':0.2,'control_steps':[5,15,35,75], 'save_images':True,'compare_fft': True,'obtain_amplitude':True ,'obtain_scalogram': False },
    ...
    # {'velocity': '1.55ms', 'D': 1.2, 'Q': 0.2, 'L0': 2590.62, 'b': 30.03, 'boundaries': [8, 22], 'min_distance': 100, 'low_pass':0.2,'control_steps':[5,15,35,75], 'save_images':False,'compare_fft': True,'obtain_amplitude':False,'obtain_scalogram': False },
    # {'velocity': '2.08ms', 'D': 1.2, 'Q': 0.2, 'L0': 4983.85, 'b': 30.94, 'boundaries': [8, 22], 'min_distance': 225, 'low_pass':0.2,'control_steps':[5,15,35,75], 'save_images':False,'compare_fft': True,'obtain_amplitude':False,'obtain_scalogram': False },
    # {'velocity': '2.61ms', 'D': 1.2, 'Q': 0.2, 'L0': 5181.56, 'b': 18.86, 'boundaries': [8, 22], 'min_distance': 200, 'low_pass':0.05,'control_steps':[5,15,35,75], 'save_images':False,'compare_fft': True,'obtain_amplitude':True,'obtain_scalogram': False },
